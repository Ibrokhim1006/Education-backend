...
class ChannelUser(models.Model):
    channel_owner = models.ForeignKey(CustomUser, null=True, blank=True, on_delete=models.CASCADE)
    channel_name = models.CharField(max_length=255, null=True, blank=True)
    channel_users = models.ManyToManyField(CustomUser, null=True, blank=True, related_name='users')
...
class Playlist(models.Model):
    ...
    playlist_owner = models.ForeignKey(CustomUser, on_delete=models.CASCADE, null=True)
