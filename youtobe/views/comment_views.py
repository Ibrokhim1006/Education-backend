...
from youtobe.serializers.comment_serializer import (
...
class CommentListView(APIView):
    ...
    def get(self, request):
        queryset = Comments.filter_user.filter_user(request.user).order_by('-id')
...
class HistoryViews(APIView):
    ...
    def get(self, request):
        queryset = UserViews.filter_user.filter_user(request.user).order_by('-id')
